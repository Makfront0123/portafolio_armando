...
export const cardProject = [
  ...
  },
  {
    id: '1',
    option: 'Frontend',
    title: 'Mariachi Villanueva Landing Page',
    framework: 'Astro',
    icon: 'vscode-icons:file-type-light-astro',
    image: '/assets/mariachi.webp',
    url: 'https://mariachi01-web.vercel.app/',
    repository: 'https://github.com/Jakex2018/mariachi01_web',
  },
  {
    id: '2',
    option: 'Frontend',
    ...
    url: 'https://barber-web01.vercel.app/',
    repository: 'https://github.com/Jakex2018/barber_web01',
  }, {
    id: '3',
    option: 'Full Stack',
