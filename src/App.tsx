...
function App() {
  ...
  return (
    <main className="relative font-georgia overflow-hidden h-full w-full p-10 flex flex-col items-center justify-center mx-auto bg-gradient-to-tr from-sky-300 via-blue-400 to-blue-400 dark:from-sky-900 dark:via-blue-800 dark:to-teal-700">
      <header className="animate-fade-top flex md:gap-x-1 gap-x-6 z-10 w-full p-4 items-center justify-between md:mr-1 mr-9 max-w-7xl">
        ...
        <div className="flex gap-4">
          ...
          <nav onClick={toggleMenu} className="md:hidden flex items-center cursor-pointer rounded-[10px] px-3 py-1" aria-label="Abrir menú">
